...
run `run_gui.ps1`, then program will open [http://0.0.0.0:28000](http://0.0.0.0:28000) automanticlly
...
run `bash run_gui.sh`, then program will open [http://0.0.0.0:28000](http://0.0.0.0:28000) automanticlly
